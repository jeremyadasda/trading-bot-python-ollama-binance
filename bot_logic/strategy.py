...
class AIStrategy:
    ...
    def ask_ai_opinion(self, current_tracked_symbols, market_summary, full_wallet_info, order_book, live_data, trade_summary, ml_score=0.5, thought_buffer=None, sentiment_score=0.0, min_notional=5.0):
